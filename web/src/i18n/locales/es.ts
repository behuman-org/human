...
export const es: SiteMessages = {
  ...
  social: {
    ...
    settings: {
      ...
      moderationLinkDesc: "Revisar casos escalados por el agente (solo contenido + seudónimo)",
    },
    moderation: {
      title: "Moderación",
      subtitle: "Casos escalados por el agente — revisión humana",
      privacyNote:
        "Solo ves contenido y seudónimo (@últimos 5 del platformId). Nunca address ni identidad real.",
      queueLabel: "Cola de moderación",
      empty: "No hay casos pendientes.",
      refresh: "Actualizar",
      approve: "Aprobar",
      flag: "Etiquetar",
      agentReason: "Motivo",
      reportReason: "Denuncias",
      sourceAgent: "Agente",
      sourceReport: "Denuncia",
      sourceBoth: "Agente + denuncias",
      reportsCount: "{count} denuncias",
      backSettings: "← Volver a configuración",
      openPanel: "Abrir panel de moderación",
      openPanelDesc: "Casos que el agente no pudo resolver automáticamente",
    },
    profile: {
