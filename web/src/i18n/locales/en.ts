...
export const en: SiteMessages = {
  ...
  social: {
    ...
    settings: {
      ...
      moderationLinkDesc: "Review cases escalated by the agent (content + pseudonym only)",
    },
    moderation: {
      title: "Moderation",
      subtitle: "Cases escalated by the agent — human review",
      privacyNote:
        "You only see content and pseudonym (@last 5 of platformId). Never address or real identity.",
      queueLabel: "Moderation queue",
      ...
      sourceAgent: "Agent",
      sourceReport: "Report",
      sourceBoth: "Agent + reports",
      reportsCount: "{count} reports",
      backSettings: "← Back to settings",
      openPanel: "Open moderation panel",
      openPanelDesc: "Cases the agent could not resolve automatically",
    },
    profile: {
